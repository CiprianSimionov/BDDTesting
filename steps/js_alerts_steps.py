...
def step_impl(context):
    ...
    context.js_alerts_page.jsconfirm_clicked_ok()
...
def step_impl(context):
    ...
    context.js_alerts_page.click_cancel_button_jsconfirm()
...
def step_impl(context):
    ...
    context.js_alerts_page.jsconfirm_clicked_cancel()
...
def step_impl(context, text):
    ...
    context.js_alerts_page.send_text_to_confirm(text)
...
def step_impl(context):
    ...
    context.js_alerts_page.you_entered_null_on_confirm()